    ...
    const sections: Section[] = [
        ...
        },
        {
            ...
            answersUr: [
                ...
                "بروکر کا انتخاب کرتے وقت درج ذیل 8 اہم نکات کا خیال رکھیں:\n\n1۔ ریگولیشن (Regulation): سب سے پہلے دیکھیں کہ بروکر FCA (UK)، ASIC (Australia) یا CySEC (Cyprus) جیسی مستند اتھارٹی سے رجسٹرڈ ہو۔\n2۔ فنڈز کی سیفٹی: بروکر ٹریڈرز کے فنڈز کو الگ (Segregated) اکاؤنٹس میں رکھتا ہو تاکہ آپ کا سرمایہ محفوظ رہے۔\n3۔ اسپریڈ اور کمیشن: کم اسپریڈ اور شفاف کمیشن والا بروکر منتخب کریں تاکہ آپ کا منافع زیادہ رہے۔\n4۔ ڈیپازٹ اور وڈراول: چیک کریں کہ رقم جمع کروانا اور نکلوانا کتنا آسان اور تیز ہے۔\n5۔ ٹریڈنگ پلیٹ فارم: بروکر MT4 یا MT5 جیسے مستحکم اور عالمی معیار کے پلیٹ فارم فراہم کرتا ہو۔\n6۔ لیوریج (Leverage): Beginner کے لیے کم لیوریج بہتر ہے۔ بہت زیادہ لیوریج دینے والے بروکر رسکی ہو سکتے ہیں۔\n7۔ کسٹمر سپورٹ: 24/5 یا 24/7 سپورٹ اور لائیو چیٹ کی سہولت موجود ہو۔\n8۔ ریویوز اور شہرت: گوگل اور فاریکس فورمز پر بروکر کے بارے میں لوگوں کے تجربات اور ریویوز لازمی دیکھیں۔",
